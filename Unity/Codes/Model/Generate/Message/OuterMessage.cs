...
// 自己unitId
	...
	[Message(OuterOpcode.A2C_Disconnet)]
	[ProtoContract]
	public partial class A2C_Disconnet: Object, IMessage
	{
		[ProtoMember(1)]
		public int Error { get; set; }
...
//定义结构体
	[Message(OuterOpcode.ServerInfosProto)]
	[ProtoContract]
	public partial class ServerInfosProto: Object
	{
		[ProtoMember(1)]
	...
	public partial class A2C_GetServerInfos: Object, IResponse
	{
		...
		[ProtoMember(1)]
		public List<ServerInfosProto> ServerInfosList = new List<ServerInfosProto>();
...
//定义结构体
	...
	public partial class A2C_GetRealmKey: Object, IResponse
	{
		...
		[ProtoMember(2)]
		public string RealmAdderss { get; set; }
